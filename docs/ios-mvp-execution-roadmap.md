...
## 10. Stage별 정량 완료 기준 (추가)
- Stage 0: 빌드 성공 + CRUD 테스트 1개+ + 수동 체크
- Stage 1: 권한/정책/Shield 에러 0건 + 실기기 권한/개입 확인
- Stage 2: 상태전이/리마인드 테스트 통과 + 실기기 종료 시나리오
- Stage 3: 기록/Intent 테스트 1개+ + Shortcuts/배포 체크

## 11. BLOCKED_MANUAL 운영 규칙(추가)
- BM 코드/담당자/해소 조건을 같은 티켓에 기록
- 해소 시 상태를 READY로 되돌린 뒤 같은 티켓 재개
